...
typedef Exit = {
    x : Int, y : Int, towards : Array<Towards>
}
...
class MapGen {
    ...
    var roomList : Array<{
        x : Int, y : Int, sample : Null<GenSample>
    }> = [];
	...
	**/
    ...
    function findGroundAroundVoid( id : Int, tiles : Array<TmxTile>, result : Array<{
        x : Int, y : Int, ?towards : Array<Towards>
    }>,
	...
	**/
    function findPossibleExits( group : TmxGroup, map : TmxMap ) : Array<{
        x : Int, y : Int, towards : Array<Towards>
    }> {
        var result : Array<{
            x : Int, y : Int, ?towards : Array<Towards>

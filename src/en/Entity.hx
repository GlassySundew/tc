...
class Entity implements NetworkSerializable {
	...
	public function init( x = 0., y = 0., z = 0., ?tmxObj : Null<TmxObject> ) {
		...
		onMoveSignal.add(() -> onMoveInvalidate = false );
	...
	**/
	...
	function applyTmx() {
		...
		if ( rigidBody != null ) {
			...
			rigidBody._transform._positionX = footX.val;
			rigidBody._transform._positionY = footY.val;
			rigidBody._transform._positionZ = footZ.val;
	...
	public function update() {
		...
		if ( onMoveInvalidate ) onMoveSignal.dispatch();
	}
